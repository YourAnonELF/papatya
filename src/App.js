...
const App = () => {
  ...
  const [showMusicPopup , setShowMusicPopup] = useState(true); // Müzik kontrolü için popup
  ...
  const startMusic = () => {
    if (audioRef.current) {
      ...
      audioRef.current.play().then(() => {
        setShowMusicPopup(false); // Pop-up'ı gizle
      ...
      <div className="animation-container">
        <div className="daisy-wrapper">
          ...
          <div 
            ...
            style={{
              opacity: Math.max(0, scrollProgress - 0),
